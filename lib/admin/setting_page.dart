    ...
    Setting_Data.getMember().then((value) {
      ...
      if (value.length == 0) {
        ...
        setState(() {
          _isLoading4 = true;
          ChartData.add(
              MemberData('customer', int.parse(setting4[0].customer)));
                                                        ...
                                                        child: DataTable2(
                                                          ...
                                                          rows: List.generate(
                                                            ...
                                                            (index) => DataRow(
                                                              cells: [
                                                                DataCell(Text(
                                                                    '${setting[index].sub_category}')),
                                                                DataCell(Center(
                                                                  child: Text(
                                                                      '${setting[index].count} 건'),
                                                                )),
                                                              ],
                                                            ),
                                                          ),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: SfCartesianChart(
                                                      ...
                                                      primaryYAxis:
                                                          NumericAxis(),
                                                      series: <
                                                          ChartSeries<Settings2,
                                                              String>>[
                                                        // Renders column chart
                                                        ColumnSeries<Settings2,
                                                            String>(
                                                          color:
                                                              Color(0xFF506AB4),
                                                          dataSource: setting2,
                                                        ...
                                                        xValueMapper:
                                                            (Settings3 setting3,
                                                                ...
                                                                setting3.index == ''
                                                                    ...
                                                                    : '제휴 파트너',
                                                        yValueMapper:
                                                            (Settings3 setting3, _) => int.parse(
                                                                setting3.count),
                                                        dataLabelMapper:
                                                            (Settings3 setting3,
                                                                    _) =>
