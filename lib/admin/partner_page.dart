                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 3,
                            child: Text('아이디',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                        Expanded(
                            flex: 6,
                            child: Text('|  ${detail2[0].pro_id}',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text('|  ${detail2[0].pro_phone}',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].com_name != '' ? '|  ${detail2[0].com_name}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].com_no != '' ? '|  ${detail2[0].com_no}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].pro_area1 != '' ? '|  ${detail2[0].pro_area1}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].pro_area2 != '' ? '|  ${detail2[0].pro_area2}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].pro_area3 != '' ? '|  ${detail2[0].pro_area3}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].pro_service1 != '' ? '|  ${detail2[0].pro_service1}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].pro_service2 != '' ? '|  ${detail2[0].pro_service2}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].pro_service3 != '' ? '|  ${detail2[0].pro_service3}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].pro_service4 != '' ? '|  ${detail2[0].pro_service4}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].pro_service5 != '' ? '|  ${detail2[0].pro_service5}' : '|  -',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text(detail2[0].index == 'alli' ? '|  재휴 파트너' : '|  일반 파트너',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            flex: 6,
                            child: Text('|  ${detail2[0].register_date}',
                              style: TextStyle(fontSize: 13.0, fontFamily: 'NanumSquareR',),
                            )
                        ),
                      ],
                    ...
                    Center(
                      child: InkWell(
                        ...
                        child: Container(
                            ...
                            child: Center(child:Text('확인', style: TextStyle(fontSize: 14.0, color: Colors.white),))
                        ),
                      )
                    )
                  ],
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Text(_isLoading1 ? '${summary[0].all_partner} 명' : '',
                                            style:TextStyle(
                                              fontSize:12,
                                              fontFamily: 'NanumSquareR',
                                            ),
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Text(_isLoading1 ? '${summary[0].alii_partner} 명' : '',
                                            style:TextStyle(
                                              fontSize:12,
                                              fontFamily: 'NanumSquareR',
                                            ),
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Text(_isLoading1 ? '${summary[0].pay_count} 명' : '',
                                            style:TextStyle(
                                              fontSize:12,
                                              fontFamily: 'NanumSquareR',
                                            ),
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text('${detail[index].pro_id}',
                                                        style:TextStyle(
                                                          fontSize:12,
                                                          fontFamily: 'NanumSquareR',
                                                        ),
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text('${detail[index].pro_phone}',
                                                        style:TextStyle(
                                                          fontSize:12,
                                                          fontFamily: 'NanumSquareR',
                                                        ),
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text('${detail[index].com_name}',
                                                        style:TextStyle(
                                                          fontSize:12,
                                                          fontFamily: 'NanumSquareR',
                                                        ),
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text('${detail[index].com_no}',
                                                        style:TextStyle(
                                                          fontSize:12,
                                                          fontFamily: 'NanumSquareR',
                                                        ),
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text(detail[index].index == 'alli' ? '제휴 파트너' : '-',
                                                        style:TextStyle(
                                                          fontSize:12,
                                                          fontFamily: 'NanumSquareR',
                                                        ),
                                                    ...
                                                    child: Center(
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                            child: InkWell(
                                                              onTap:(){selectPro('${detail[index].pro_id}');},
                                                              child: Container(
                                                                height:25,
                                                                decoration:BoxDecoration(
                                                                    borderRadius: BorderRadius.circular(5),
